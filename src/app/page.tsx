        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <h1 className="text-xl font-bold text-blue-600">SwiftInvoice</h1>
            </div>
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                  ...
                  <span className="block text-blue-600 xl:inline">Invoicing Made Simple</span>
                </h1>
          ...
          <div className="mt-10">
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              <div className="relative">
                ...
                <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Client Management</p>
              ...
              <div className="relative">
                ...
                <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Professional Invoices</p>
                <p className="mt-2 ml-16 text-base text-gray-500">

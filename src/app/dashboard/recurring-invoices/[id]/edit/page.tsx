...
export default function EditRecurringInvoicePage() {
  ...
  const fetchRecurringInvoice = async () => {
    try {
      ...
      setError(err instanceof Error ? err.message : 'Failed to fetch recurring invoice')
    }
  }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.error || 'Failed to update recurring invoice')
      }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              ...
              <p className="mt-2 text-gray-600">Update your recurring invoice settings</p>
            </div>
            <Link

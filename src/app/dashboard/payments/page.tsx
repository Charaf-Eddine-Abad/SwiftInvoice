        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              ...
              <p className="mt-2 text-gray-600">Connect payment providers to accept online payments</p>
            </div>
            <Link
              href="/dashboard"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h3 className="text-lg font-medium text-blue-800">Payment Processing Coming Soon</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {paymentProviders.map((provider) => (
            <div key={provider.name} className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
              {/* Provider Header */}
              ...
              <div className="p-6">
                ...
                <button
                  ...
                  className="w-full bg-gray-100 hover:bg-gray-200 text-gray-700 py-3 px-4 rounded-md font-medium transition-colors cursor-not-allowed"
                  disabled
                >
        ...
        <div className="mt-12 bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Why Payment Processing?</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <h4 className="font-medium text-gray-900 mb-2">Faster Payments</h4>
              <p className="text-sm text-gray-600">Get paid instantly with online payment processing</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Bank-level security with fraud protection</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Seamless setup with your existing invoices</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
          <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div className="mt-3 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mt-4">Payments Coming Soon</h3>
